...
export const mockReferences: Reference[] = [
  ...
  {
    id: "ref_009",
    title: "High Fiber Diet Benefits Explained",
    sourcePlatform: "youtube",
    url: "https://www.youtube.com/watch?v=fiberbenefits123",
    tags: ["fiber", "nutrition", "health", "diet"],
    description: "Comprehensive guide to high fiber diet benefits and food sources.",
    relatedProductId: "prod_001",
    addedBy: "user_001",
    dateAdded: "2025-08-14T10:00:00Z",
    thumbnailUrl: "https://cdn.example.com/thumbnails/ref_009.jpg",
    durationSeconds: 845,
    notes: "Great educational content about fiber benefits."
  },
  {
    id: "ref_010",
    title: "TikTok: Healthy Snack Ideas for Work",
    sourcePlatform: "tiktok",
    url: "https://www.tiktok.com/@nutritionist/video/healthysnacks123",
    tags: ["healthy", "snack", "work", "nutrition"],
    description: "Quick healthy snack ideas perfect for office workers.",
    relatedProductId: "prod_001",
    addedBy: "user_003",
    dateAdded: "2025-08-14T14:30:00Z",
    thumbnailUrl: "https://cdn.example.com/thumbnails/ref_010.jpg",
    durationSeconds: 32,
    notes: "Trending healthy snacking content."
  },
  {
    id: "ref_011",
    title: "Instagram: Fiber-Rich Breakfast Bowls",
    sourcePlatform: "instagram",
    url: "https://www.instagram.com/p/fiberbreakfast123",
    tags: ["fiber", "breakfast", "healthy", "bowl"],
    description: "Beautiful breakfast bowl recipes high in fiber content.",
    relatedProductId: "prod_001",
    addedBy: "user_002",
    dateAdded: "2025-08-15T09:15:00Z",
    thumbnailUrl: "https://cdn.example.com/thumbnails/ref_011.jpg",
    durationSeconds: 0,
    notes: "Visual inspiration for fiber-rich meals."
  },
  {
    id: "ref_012",
    title: "LinkedIn: Wellness Trends 2025",
    sourcePlatform: "linkedin",
    url: "https://www.linkedin.com/posts/wellness-expert_trends-2025",
    tags: ["wellness", "trends", "lifestyle", "health"],
    description: "Analysis of emerging wellness and lifestyle trends for 2025.",
    relatedProductId: "prod_001",
    addedBy: "user_001",
    dateAdded: "2025-08-15T16:45:00Z",
    thumbnailUrl: "https://cdn.example.com/thumbnails/ref_012.jpg",
    durationSeconds: 0,
    notes: "Industry insights on wellness trends."
  },
  {
    id: "ref_013",
    title: "Twitter: Social Media Food Trends",
    sourcePlatform: "twitter",
    url: "https://twitter.com/foodtrends/status/socialfood123",
    tags: ["social", "trend", "food", "viral"],
    description: "Thread about viral food trends on social media platforms.",
    relatedProductId: "prod_001",
    addedBy: "user_003",
    dateAdded: "2025-08-16T11:20:00Z",
    thumbnailUrl: "https://cdn.example.com/thumbnails/ref_013.jpg",
    durationSeconds: 0,
    notes: "Understanding viral food content patterns."
  }
];
