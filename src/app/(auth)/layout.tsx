  ...
  return (
    <div className="flex flex-col sm:flex-row h-screen justify-center items-center w-full bg-red">
      <div className="flex-2 justify-center items-center w-full h-full">
        <div
          className="relative flex flex-col justify-center w-full h-full items-center overflow-hidden
        bg-accent"
        >
          <Image
            ...
            style={{
              filter:
                "contrast(1.6) brightness(1.3) hue-rotate(490deg) invert(1)",
            }}
          />
        </div>
      </div>
