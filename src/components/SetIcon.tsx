...
const SetIcon = ({ color, fill, animated = false, loading = false, ...props }: SetIconProps) => {
  ...
  const loadingAnimationStyle = loading ? {
    animation: 'staggeredBounce 1.2s ease-in-out infinite',
  ...
  const loadingDelays = [
    ...
    '560ms', '640ms', '720ms', '800ms', '880ms', '960ms', '1040ms'
  ];
    ...
    <>
      ...
      >
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[0] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[0] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[1] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[1] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[2] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[2] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[3] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[3] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[4] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[4] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[5] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[5] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[6] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[6] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[7] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[7] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[8] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[8] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[9] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[9] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[10] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[10] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[11] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[11] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[12] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[12] }
              : {}
          }
        />
        <path
          ...
          style={
            loading
              ? { ...loadingAnimationStyle, animationDelay: loadingDelays[13] }
              : animated
              ? { ...animationStyle, animationDelay: animationDelays[13] }
              : {}
          }
        />
        <defs>
